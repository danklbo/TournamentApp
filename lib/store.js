...
const initialGroups = [
  {
    name: 'A',
    teams: [
      { id: 'B1', name: 'Henkel 1', points: 0 },
      { id: 'B2', name: 'Kuriatka', points: 0 },
      { id: 'B3', name: 'Gumkači', points: 0 },
      { id: 'B4', name: 'Beauties and beasts', points: 0 },
      { id: 'B5', name: 'Ropaci', points: 0 }
    ],
    matches: []
  },
  {
    name: 'B',
    teams: [
      { id: 'A1', name: 'Henkel 2', points: 0 },
      { id: 'A2', name: 'Fireballs', points: 0 },
      { id: 'A3', name: 'Lotosove kvety', points: 0 },
      { id: 'A4', name: 'Loptoši', points: 0 },
      { id: 'A5', name: 'Štatistika', points: 0 }
    ],
    matches: []
  }
